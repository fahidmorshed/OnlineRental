<?php
    foreach($reporter_data as $row){
?>
    <div class="row">
        <div class="col-md-12">
			<?php
                echo form_open(base_url() . 'index.php/admin/reporter/update/' . $row['reporter_id'], array(
                    ...
                    <div class="form-group btm_border">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="name" id="name" 
                                placeholder="<?php echo translate('reporter_name');?>" class="form-control required" value="<?php echo $row['name']; ?>">
                        </div>
                    </div>
                 ...
                 <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="designation" id="designation" 
                            placeholder="<?php echo translate('reporter_designation');?>" class="form-control required" value="<?php echo $row['designation']; ?>">
                    </div>
                </div>
                 <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="phone" id="phone" 
                            placeholder="<?php echo translate('reporter_phone');?>" class="form-control required" value="<?php echo $row['phone']; ?>">
                    </div>
                </div>
                 ...
                 <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="email" id="email" 
                            placeholder="<?php echo translate('reporter_email');?>" class="form-control required" value="<?php echo $row['email']; ?>">
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            	onclick="ajax_set_full('edit','<?php echo translate('edit_reporter'); ?>','<?php echo translate('successfully_edited!'); ?>','reporter_edit','<?php echo $row['reporter_id']; ?>')">
                                	<?php echo translate('reset');?>
                            </span>
                        </div>
                        
                        <div class="col-md-1">
                            <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('reporter_edit','<?php echo translate('successfully_edited!'); ?>')" ><?php echo translate('upload');?></span>
                        </div>
