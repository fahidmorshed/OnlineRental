q<div class="row">
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'index.php/admin/video/do_add/', array(
        ...
        ?>
                ...
                <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="title" id="title" 
                        	placeholder="<?php echo translate('video_title');?>" class="form-control required">
                    </div>
                </div>

                 <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="video_type"><?php echo translate('video_type');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="type" id="type" 
                        	placeholder="<?php echo translate('video_type');?>" class="form-control required">
                    </div>
                </div>
                 <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="link" id="link" 
                        	placeholder="<?php echo translate('video_link');?>" class="form-control required">
                    </div>
                </div>

                 <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="video_link"><?php echo translate('video_status');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="status" id="status" 
                        	placeholder="<?php echo translate('video_status');?>" class="form-control required">
                    </div>
                </div>
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('video_add','<?php echo translate('successfully_added!'); ?>')" ><?php echo translate('upload');?></span>
                    </div>
