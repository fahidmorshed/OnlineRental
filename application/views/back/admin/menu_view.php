...
?>
    <div id="content-container" style="padding-top:0px !important;">
        <div class="text-center pad-all">
            <div class="pad-ver">
                <img 
                    <?php if(file_exists('uploads/menu_image/menu_'.$row['menu_id'].'.jpg')){ ?>
                        src="<?php echo base_url(); ?>uploads/menu_image/menu_<?php echo $row['menu_id']; ?>.jpg"
                    <?php } else if($row['fb_id'] !== ''){ ?>
                        src="https://graph.facebook.com/<?php echo $row['fb_id']; ?>/picture?type=large" 
                    <?php } else { ?>
                        src="<?php echo base_url(); ?>template/front/uploads/img/menu.jpg"
                    <?php } ?>
                    class="img-md img-border img-circle" alt="Profile Picture">
            </div>
            <h4 class="text-lg text-overflow mar-no"><?php echo $row['menuname']?></h4>
            <p class="text-sm"><?php echo translate('menu');?></p>
            ...
            <div class="panel-body">
                <table class="table table-striped" style="border-radius:3px;">
                    <tr>
                        ...
                        <td class="custom_td"><?php echo $row['menuname'].' '.$row['surname']; ?></td>
                    </tr>
                    <tr>
