<div id="content-container">
	<div id="menu-title">
		<h1 class="menu-header text-overflow"><?php echo translate('manage_menu');?></h1>
	</div>
        <div class="tab-base">
            <div class="panel">
                    ...
                    <div class="tab-content">
                        <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
                            <button class="btn btn-primary btn-labeled fa fa-plus-circle add_pro_btn pull-right" 
                                onclick="ajax_set_full('add','<?php echo translate('add_menu'); ?>','<?php echo translate('successfully_added!'); ?>','menu_add',''); proceed('to_list');">
                            ...
                            <button class="btn btn-info btn-labeled fa fa-step-backward pull-right pro_list_btn" 
                                style="display:none;"  onclick="ajax_set_list();  proceed('to_add');">
									<?php echo translate('back_to_menu_list');?>
                            			</button>
                        </div>
                    <!-- LIST -->
