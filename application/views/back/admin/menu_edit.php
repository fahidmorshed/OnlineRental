            ...
            ?>
                <div class="panel-body">
                    <div class="form-group btm_border">
                        <label class="col-sm-4 control-label" for="menu_title"><?php echo translate('menu_title');?></label>
                        <div class="col-sm-6">
                            <input type="text" name="title" id="title" 
                                placeholder="<?php echo translate('menu_title');?>" class="form-control required" value="<?php echo $row['title']; ?>">
                        </div>
                    </div>


                 <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="menu_type"><?php echo translate('menu_type');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="type" id="type" 
                            placeholder="<?php echo translate('menu_type');?>" class="form-control required" value="<?php echo $row['type']; ?>">
                    </div>
                </div>
                 <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="menu_detail"><?php echo translate('menu_detail');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="detail" id="detail" 
                            placeholder="<?php echo translate('menu_detail');?>" class="form-control required" value="<?php echo $row['detail']; ?>">
                    </div>
                </div>

                <div class="form-group abstract">
                  <label class="col-sm-4 control-label"><?php echo translate('menu_detail');?></label>
                  <div class="col-sm-6">
                    <textarea class="summernotes"  data-height="200" data-name="detail" ><?php echo $row['detail'];?></textarea>
                  </div>
               </div>

            
                <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="menu_status"><?php echo translate('menu_status');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="status" id="status" 
                            placeholder="<?php echo translate('menu_status');?>" class="form-control required" value="<?php echo $row['status']; ?>">
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            	onclick="ajax_set_full('edit','<?php echo translate('edit_menu'); ?>','<?php echo translate('successfully_edited!'); ?>','menu_edit','<?php echo $row['menu_id']; ?>')">
                                	<?php echo translate('reset');?>
                            </span>
                        </div>
                        
                        <div class="col-md-1">
                            <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('menu_edit','<?php echo translate('successfully_edited!'); ?>')" ><?php echo translate('upload');?></span>
                        </div>
...
?>
    ...
    <script>
        ...
        $(document).ready(function() {
			...
			$('.menu_select').each(function(index, element) {
				var a = $(this).val();
		...
		$("#part_num").click(function(){
			...
			htmls =	htmls
				...
				+'					<option value="menu"><?php echo translate('menu'); ?></option>'
				+'    			</select>'
				+'   		 </div>'
				+'    		<div class="col-sm-12 menu" style="display:none;">'
				+'				<select class="demo-cs-multiselect menu_select" name="" multiple >'
				...
				+'  		  	</select>'
				+'  		  </div>'
				+'  		  <input type="hidden" name="part_menu[]" class="hidd" />'
        ...
        $('body').on('change', '.type', function(){	
            ...
            var a = h.val();
            if(a == 'menu'){
                h.parent().parent().find('.menu').show();
                h.parent().parent().find('.content').hide();
            } else if (a == 'content'){
                h.parent().parent().find('.menu').hide();
