			...
			<tr>
				...
				<td class="text-right">
                    ...
                    <a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                    	onclick="ajax_set_full('edit','<?php echo translate('edit_poll'); ?>','<?php echo translate('successfully_edited!'); ?>','poll_edit','<?php echo $row['poll_id']; ?>')" data-original-title="Edit" data-container="body">
