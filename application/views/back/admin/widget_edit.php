            ...
            ?>
                <div class="panel-body">
                    <div class="form-group btm_border">
                        <label class="col-sm-4 control-label" for="widget_title"><?php echo translate('widget_title');?></label>
                        <div class="col-sm-6">
                            <input type="text" name="title" id="title" 
                                placeholder="<?php echo translate('widget_title');?>" class="form-control required" value="<?php echo $row['title']; ?>">
                        </div>
                    </div>


                 <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="widget_type"><?php echo translate('widget_type');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="type" id="type" 
                            placeholder="<?php echo translate('widget_type');?>" class="form-control required" value="<?php echo $row['type']; ?>">
                    </div>
                </div>
                 <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="widget_detail"><?php echo translate('widget_detail');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="detail" id="detail" 
                            placeholder="<?php echo translate('widget_detail');?>" class="form-control required" value="<?php echo $row['detail']; ?>">
                    </div>
                </div>

                  <div class="form-group abstract">
                        <label class="col-sm-4 control-label"><?php echo translate('widget_detail');?></label>
                        <div class="col-sm-6">
                 ...
                 <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="widget_position"><?php echo translate('widget_position');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="position" id="position" 
                            placeholder="<?php echo translate('widget_position');?>" class="form-control required" value="<?php echo $row['position']; ?>">
                    </div>
                </div>

                <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="widget_status"><?php echo translate('widget_status');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="status" id="status" 
                            placeholder="<?php echo translate('widget_status');?>" class="form-control required" value="<?php echo $row['status']; ?>">
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            	onclick="ajax_set_full('edit','<?php echo translate('edit_widget'); ?>','<?php echo translate('successfully_edited!'); ?>','widget_edit','<?php echo $row['widget_id']; ?>')">
                                	<?php echo translate('reset');?>
                            </span>
                        </div>
                        
                        <div class="col-md-1">
                            <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('widget_edit','<?php echo translate('successfully_edited!'); ?>')" ><?php echo translate('upload');?></span>
                        </div>
