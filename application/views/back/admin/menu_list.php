			...
			<tr>
				...
				<td class="text-right">
                    ...
                    <a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                    	onclick="ajax_set_full('edit','<?php echo translate('edit_menu'); ?>','<?php echo translate('successfully_edited!'); ?>','menu_edit','<?php echo $row['menu_id']; ?>')" data-original-title="Edit" data-container="body">
                        	<?php echo translate('edit');?>
                    </a>
                    
					<a onclick="delete_confirm('<?php echo $row['menu_id']; ?>','<?php echo translate('really_want_to_delete_this?'); ?>')" 
