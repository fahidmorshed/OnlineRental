        ...
        ?>
            <div class="panel-body">
                <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="title" id="title" 
                        	placeholder="<?php echo translate('widget_title');?>" class="form-control required">
                    </div>
                </div>
                 ...
                 <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="type" id="type" 
                        	placeholder="<?php echo translate('widget_type');?>" class="form-control required">
                    </div>
                </div>
                ...
                <div class="form-group abstract">
                  ...
                  <div class="col-sm-6">
                    <textarea class="summernotes"  data-height="200" data-name="detail" ></textarea>
                  </div>
               </div>
                 ...
                 <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="position" id="position" 
                        	placeholder="<?php echo translate('widget_position');?>" class="form-control required">
                    </div>
                </div>
                ...
                <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="status" id="status" 
                        	placeholder="<?php echo translate('widget_status');?>" class="form-control required">
                    </div>
                </div>
                ...
                <div class="row">
                	<div class="col-md-11">
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('add','<?php echo translate('add_widget'); ?>','<?php echo translate('successfully_added!'); ?>','widget_add',''); ">
                            	<?php echo translate('reset');?>
                        </span>
                    </div>
                    
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('widget_add','<?php echo translate('successfully_added!'); ?>')" ><?php echo translate('upload');?></span>
                    </div>
