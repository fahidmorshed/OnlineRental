q<div class="row">
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'index.php/admin/useful_link/do_add/', array(
                ...
                <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="title" id="title" 
                        	placeholder="<?php echo translate('useful_link_title');?>" class="form-control required">
                    </div>
                </div>
                 ...
                 <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="link" id="link" 
                        	placeholder="<?php echo translate('useful_link_link');?>" class="form-control required">
                    </div>
                </div>
                ...
                <div class="row">
                	<div class="col-md-11">
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('add','<?php echo translate('add_useful_link'); ?>','<?php echo translate('successfully_added!'); ?>','useful_link_add',''); ">
                            	<?php echo translate('reset');?>
                        </span>
                    </div>
                    
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('useful_link_add','<?php echo translate('successfully_added!'); ?>')" ><?php echo translate('upload');?></span>
                    </div>
