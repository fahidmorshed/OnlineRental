q<div class="row">
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'index.php/admin/poll/do_add/', array(
                 ...
                 <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="options" id="options" 
                        	placeholder="<?php echo translate('poll_options');?>" class="form-control required">
                    </div>
                </div>
                 <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="status" id="status" 
                        	placeholder="<?php echo translate('poll_status');?>" class="form-control required">
                    </div>
                </div>
