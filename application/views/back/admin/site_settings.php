        ...
        <div class="panel">
            <div class="tab-base tab-stacked-left">
                            ...
                            ?>
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="system_name" value="<?php echo $this->crud_model->get_field('general_settings','1','value'); ?>"  class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" ><?php echo translate('system_email');?></label>
                                        <div class="col-sm-6">
                                            <input type="text" name="system_email" value="<?php echo $this->crud_model->get_field('general_settings','2','value'); ?>"  class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" ><?php echo translate('system_title');?></label>
                                        <div class="col-sm-6">
                                            <input type="text" name="system_title" value="<?php echo $this->crud_model->get_field('general_settings','3','value'); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" ><?php echo translate('downloadable_product_folder_name');?></label>
                                        <div class="col-sm-6">
                                            <input type="text" name="file_folder" value="<?php echo $this->crud_model->get_field('general_settings','60','value'); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" ><?php echo translate('homepage_cache_time');?> (Munites)</label>
                                        <div class="col-sm-4">
                                            <input type="number" min='0' step='.01' name="cache_time" value="<?php echo $this->crud_model->get_field('general_settings','59','value'); ?>" class="form-control">
                                        </div>
                                        <div class="col-sm-2">
                                            Munites
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="vendor_system" class='sw7' data-set='set_vendor_system' type="checkbox" <?php if($this->crud_model->get_field('general_settings','58','value') == 'ok'){ ?>checked<?php } ?> name="vendor_system" value="ok" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="admin_noti_sound" class='sw5' data-set='set_admin_notification_sound' type="checkbox" <?php if($this->crud_model->get_field('general_settings','45','value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                    <?php
                                        $ad_volume = $this->crud_model->get_field('general_settings','46','value');
                                    ?>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="home_noti_sound" class='sw5' data-set='set_home_notification_sound' type="checkbox" <?php if($this->crud_model->get_field('general_settings','49','value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                    
                                    <?php
                                        $hom_volume = $this->crud_model->get_field('general_settings','50','value');
                                    ?>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" >
                            ...
                            <div class="panel-body">
                                ...
                                ?>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="set_slider" class='sw4' data-set='set_slider' type="checkbox" <?php if($this->crud_model->get_field('general_settings','53','value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"><?php echo translate('category_menu_slider');?></label>
                                        <div class="col-sm-6">
                                            <input id="set_slides" class='sw4' data-set='set_slides' type="checkbox" <?php if($this->crud_model->get_field('general_settings','62','value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <?php
                                                $category = $this->crud_model->get_field('ui_settings','10','value');
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <?php
                                                $brands = $this->crud_model->get_field('ui_settings','13','value');
                                    ...
                                    <div class="form-group mar-btm">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group mar-btm">
                                                ...
                                                <input type="text" name="facebook" value="<?php echo $this->crud_model->get_field('social_links','1','value'); ?>" id="demo-hor-inputemail" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <!--G+---------->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group mar-btm">
                                                ...
                                                <input type="text" name="google-plus" value="<?php echo $this->crud_model->get_field('social_links','2','value'); ?>" id="demo-hor-inputemail" class="form-control">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group mar-btm">
                                                ...
                                                <input type="text" name="twitter" value="<?php echo $this->crud_model->get_field('social_links','3','value'); ?>" id="demo-hor-inputemail" class="form-control">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group mar-btm">
                                                ...
                                                <input type="text" name="pinterest" value="<?php echo $this->crud_model->get_field('social_links','5','value'); ?>" id="demo-hor-inputemail" class="form-control">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group mar-btm">
                                                ...
                                                <input type="text" name="skype" value="<?php echo $this->crud_model->get_field('social_links','4','value'); ?>" id="demo-hor-inputemail" class="form-control">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group mar-btm">
                                                ...
                                                <input type="text" name="youtube" value="<?php echo $this->crud_model->get_field('social_links','6','value'); ?>" id="demo-hor-inputemail" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <?php 
					...
					$fb_login_set = $this->crud_model->get_field('general_settings','51','value');
					$g_login_set = $this->crud_model->get_field('general_settings','52','value');
                ?>
							<?php
